    ...
    return (
        <div className="relative flex flex-col items-center justify-center w-full ">
            ...
            <div className="absolute top-[75%] text-white text-center">
                ...
                <Link to="/">
                    <button className="btn border border-white px-8 py-1 btn-outline text-[18px] font-medium mt-4 hover:bg-gradient-to-r from-blue-800 to-blue-950 hover:text-green-500 text-white hover:-translate-y-1">Go Home</button>
                </Link>
            </div>
        </div>
    );
